            ...
            switch (type) {
              ...
              case PageTransitionType.fadeIn:
                return FadeTransition(
                  opacity: Tween<double>(begin: 0, end: 1.0).animate(animatedCurve),
                  child: child,
                );
              case PageTransitionType.scaleUp:
                return ScaleTransition(
                  scale: Tween<double>(begin: 0, end: 1.0).animate(animatedCurve),
                  child: child,
                );
              case PageTransitionType.scaleDown:
                return ScaleTransition(
                  scale: Tween<double>(begin: 2, end: 1.0).animate(animatedCurve),
                  child: child,
                );
              case PageTransitionType.scaleUpWithFadeIn:
                return ScaleTransition(
                  scale: Tween<double>(begin: 0.8, end: 1.0).animate(animatedCurve),
              ...
              case PageTransitionType.scaleDownWithFadeIn:
                return ScaleTransition(
                  scale: Tween<double>(begin: 1.2, end: 1.0).animate(animatedCurve),
                  child: FadeTransition(
                    opacity: Tween<double>(begin: 0, end: 1.0).animate(animatedCurve),
                    child: child,
                  ),
              ...
              case PageTransitionType.fromTop:
                return SlideTransition(
                  position: Tween<Offset>(begin: const Offset(0, -1.0), end: const Offset(0, 0))
                      .animate(animatedCurve),
                  child: child,
                );
              case PageTransitionType.fromLeft:
                return SlideTransition(
                  position: Tween<Offset>(begin: const Offset(-1.0, 0), end: const Offset(0, 0))
                      .animate(animatedCurve),
                  child: child,
                );
